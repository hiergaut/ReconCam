...
QStyledItemDelegateOpengl::QStyledItemDelegateOpengl(QAbstractItemModel* model, QObject* parent)
...
//void QStyledItemDelegateOpengl::paint(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
//{
//    qDebug() << "paint : " << _model->data(index).toString();
//    return;
...
QSize QStyledItemDelegateOpengl::sizeHint(const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    qDebug() << "sizeHint " << _model->data(index).toString();
